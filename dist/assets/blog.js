...
define('blog/controllers/task', ['exports', 'ember', 'ember-data'], function (exports, Ember, DS) {
	...
	exports['default'] = Ember['default'].ObjectController.extend(TaskController);
...
define('blog/routes/task', ['exports', 'ember'], function (exports, Ember) {
...
define('blog/routes/tasks', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child2 = (function() {
      return {
        ...
        hasRendered: false,
        build: function build(dom) {
          var el0 = dom.createTextNode("Todos ");
          return el0;
        },
        render: function render(context, env, contextualElement) {
          var dom = env.dom;
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        block(env, morph2, context, "link-to", ["tasks"], {}, child2, null);
...
define('blog/templates/task', ['exports'], function (exports) {
...
define('blog/templates/tasks', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      ...
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          var morph0 = dom.createMorphAt(dom.childAt(fragment, [1]),0,-1);
          block(env, morph0, context, "link-to", ["task", get(env, context, "this")], {}, child0, null);
          return fragment;
        }
      };
    }());
    return {
      ...
      build: function build(dom) {
        var el0 = dom.createDocumentFragment();
        var el1 = dom.createElement("h3");
        var el2 = dom.createTextNode("Add new task");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n");
        dom.appendChild(el0, el1);
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph2 = dom.createMorphAt(dom.childAt(fragment, [6, 1]),0,-1);
        var morph3 = dom.createMorphAt(dom.childAt(fragment, [8]),0,1);
        inline(env, morph0, context, "input", [], {"type": "text", "value": get(env, context, "title"), "placeholder": "title"});
        inline(env, morph1, context, "textarea", [], {"value": get(env, context, "body"), "placeholder": "description"});
        element(env, element1, context, "action", ["add"], {});
        block(env, morph2, context, "each", [], {}, child0, null);
        content(env, morph3, context, "outlet");
        return fragment;
      }
    };
...
define('blog/tests/controllers/post.jshint', function () {
  ...
  test('controllers/post.js should pass jshint', function() { 
    ok(false, 'controllers/post.js should pass jshint.\ncontrollers/post.js: line 1, col 1, \'import\' is only available in ES6 (use esnext option).\ncontrollers/post.js: line 15, col 1, \'export\' is only available in ES6 (use esnext option).\n\n2 errors'); 
  });
...
define('blog/tests/controllers/task.jshint', function () {
  ...
  test('controllers/task.js should pass jshint', function() { 
    ok(false, 'controllers/task.js should pass jshint.\ncontrollers/task.js: line 1, col 1, \'import\' is only available in ES6 (use esnext option).\ncontrollers/task.js: line 2, col 1, \'import\' is only available in ES6 (use esnext option).\ncontrollers/task.js: line 24, col 1, \'export\' is only available in ES6 (use esnext option).\n\n3 errors'); 
  });
...
define('blog/tests/helpers/format-date.jshint', function () {
  ...
  test('helpers/format-date.js should pass jshint', function() { 
    ok(false, 'helpers/format-date.js should pass jshint.\nhelpers/format-date.js: line 3, col 1, \'import\' is only available in ES6 (use esnext option).\nhelpers/format-date.js: line 5, col 1, \'export\' is only available in ES6 (use esnext option).\n\n2 errors'); 
  });
...
define('blog/tests/helpers/format-markdown.jshint', function () {
  ...
  test('helpers/format-markdown.js should pass jshint', function() { 
    ok(false, 'helpers/format-markdown.js should pass jshint.\nhelpers/format-markdown.js: line 3, col 1, \'import\' is only available in ES6 (use esnext option).\nhelpers/format-markdown.js: line 5, col 1, \'export\' is only available in ES6 (use esnext option).\n\n2 errors'); 
  });
...
define('blog/tests/models/author.jshint', function () {
  ...
  test('models/author.js should pass jshint', function() { 
    ok(false, 'models/author.js should pass jshint.\nmodels/author.js: line 1, col 1, \'import\' is only available in ES6 (use esnext option).\nmodels/author.js: line 3, col 1, \'export\' is only available in ES6 (use esnext option).\n\n2 errors'); 
  });
...
define('blog/tests/models/post.jshint', function () {
  ...
  test('models/post.js should pass jshint', function() { 
    ok(false, 'models/post.js should pass jshint.\nmodels/post.js: line 1, col 1, \'import\' is only available in ES6 (use esnext option).\nmodels/post.js: line 5, col 1, \'export\' is only available in ES6 (use esnext option).\n\n2 errors'); 
  });

});
define('blog/tests/models/task.jshint', function () {

  'use strict';

  module('JSHint - models');
  test('models/task.js should pass jshint', function() { 
    ok(false, 'models/task.js should pass jshint.\nmodels/task.js: line 1, col 1, \'import\' is only available in ES6 (use esnext option).\nmodels/task.js: line 3, col 1, \'export\' is only available in ES6 (use esnext option).\n\n2 errors'); 
  });
